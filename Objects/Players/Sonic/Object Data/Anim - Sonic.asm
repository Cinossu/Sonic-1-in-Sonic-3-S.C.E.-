...
AniSonic: offsetTable
		...
		ptrTableEntry.w SonAni_Float		; E
		ptrTableEntry.w SonAni_FloatSpin	; F
		ptrTableEntry.w SonAni_Spring		; 10
		ptrTableEntry.w SonAni_HangOn		; 11
		ptrTableEntry.w SonAni_Victory		; 13
		ptrTableEntry.w SonAni_Hang		; 14
		ptrTableEntry.w SonAni_Slide		; 19
		ptrTableEntry.w SonAni_GetAir		; 15
		ptrTableEntry.w SonAni_Drown		; 17
		ptrTableEntry.w SonAni_Hurt		; 1A
...
SonAni_RollFast:	dc.b $FE, $96, $97, $96, $98, $96, $99, $96, $9A, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF
...
SonAni_BalanceEdge:	dc.b 5, $A1, $A2, $A3, $FF
...
SonAni_FloatSpin:	dc.b 7, $C8, $C9, $CA, $CB, $CC, $CD, $CE, $CF, $FF
SonAni_Spring:		dc.b $2F, $8E, $FD, 0
SonAni_HangOn:		dc.b 1, $AA, $AB, $FF
SonAni_Victory:		dc.b 7, $B0, $B2, $B2, $B2, $B2, $B2, $B2, $B1, $B2, $B3, $B2, $FE, 4
SonAni_Hang:		dc.b $13, $91, $FF
