...
AniSuperSonic: offsetTable
		...
		offsetTableEntry.w SonAni_Float		; E
		offsetTableEntry.w SonAni_FloatSpin	; F
		offsetTableEntry.w SonAni_Spring	; 10
		offsetTableEntry.w SonAni_HangOn	; 11
		offsetTableEntry.w SonAni_Victory	; 13
		offsetTableEntry.w SonAni_Hang		; 14
		offsetTableEntry.w SonAni_Slide		; 19
