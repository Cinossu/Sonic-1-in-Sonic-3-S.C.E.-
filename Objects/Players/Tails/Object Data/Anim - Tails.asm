...
AniTails: offsetTable
		...
		ptrTableEntry.w TailsAni_RollFast	; 3
		...
		ptrTableEntry.w TailsAni_BalanceEdge	; C
		ptrTableEntry.w TailsAni_Stop		; D
		ptrTableEntry.w TailsAni_Float		; E
		ptrTableEntry.w TailsAni_FloatSpin	; F
		ptrTableEntry.w TailsAni_Spring		; 10
		ptrTableEntry.w TailsAni_HangOn		; 11
		ptrTableEntry.w TailsAni_Victory	; 13
		ptrTableEntry.w TailsAni_Hang		; 14
		ptrTableEntry.w TailsAni_Slide		; 19
		ptrTableEntry.w TailsAni_GetAir		; 15
		ptrTableEntry.w TailsAni_Drown		; 17
		ptrTableEntry.w TailsAni_Hurt		; 1A
...
TailsAni_RollFast:	dc.b 0, $96, $97, $98, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF
...
TailsAni_Balance:	dc.b 9, $9A, $9A, $9B, $9B, $9A, $9A, $9B, $9B, $9A, $9A, $9B, $9B, $9A, $9A, $9B, $9B, $9A, $9A, $9B
			dc.b $9B, $9A, $9B, $FF
TailsAni_BalanceEdge:	dc.b 9, $A4, $9B, $FF
...
TailsAni_FloatSpin:	dc.b 9, $B5, $B6, $B7, $B8, $B9, $BA, $BB, $BC, $FF
TailsAni_Spring:	dc.b 3, $8B, $8C, $8B, $8C, $8B, $8C, $8B, $8C, $8B, $8C, $8B, $8C, $FD, 0
TailsAni_HangOn:	dc.b 1, $9D, $9E, $FF
TailsAni_Victory:	dc.b $F, $A5, $A6, $FE, 1
TailsAni_Hang:		dc.b $13, $91, $FF
...
AniTails2A:		dc.b 5, $F0, $F0, $EF, $F0, $EF, $F0, $F1, $F2, $FE, 1
	even
