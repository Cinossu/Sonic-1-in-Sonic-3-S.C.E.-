...
word_23788:	dc.w 2			; facing up
		dc.b $F8, $C, 0, 0, $FF, $F0
		dc.b 0,	$C, 0, 4, $FF, $F0

word_23796:	dc.w 1			; facing up, flattened
		dc.b 0,	$C, 0, 0, $FF, $F0

word_2379E:	dc.w 3			; facing up, extended
		dc.b $E8, $C, 0, 0, $FF, $F0
		dc.b $F0, 5, 0,	8, $FF, $F8
		dc.b 0,	$C, 0, $C, $FF, $F0

word_237D0:	dc.w 1			; facing left
		dc.b $F0, 7, 0,	$10, $FF, $F8

word_237DE:	dc.w 1			; facing left, flattened
		dc.b $F0, 3, 0,	$14, $FF, $F8

word_237E6:	dc.w 4			; facing left, extended
		dc.b $F0, 3, 0,	$14, 0, $10
		dc.b $F8, 9, 0,	$18, $FF, $F8
		dc.b $F0, 0, 0,	$10, $FF, $F8
		dc.b 8,	0, 0, $13, $FF, $F8
		
word_23818:	dc.w 2			; facing down
		dc.b 0, $C, $10, 0, $FF, $F0
